...
<?php 
	...
	switch ($source) {
		...
		case 'add_category':
			include "addincludes/add_category.php";
			break;

			case 'edit_category':
			include "addincludes/edit_category.php";
			break;
			
			case 'add_mother_category':
			include "addincludes/add_mother_category.php";
			break;

		
		default:
			include "addincludes/allcategories.php";
			break;
	}
