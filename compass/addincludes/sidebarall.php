<?php 
if ($session_role !== 'Superadmin') {die("Lets get out of here stranger!");}
?>
...
<div class="sidebar-menu">
		...
		<div class="sidebar-menu-inner">
			...
			<ul id="main-menu" class="main-menu">
				...
				<?php if (strpos($_SERVER['REQUEST_URI'], 'saved') == true): ?>
			<li class="active">
			<?php else: ?>
				<li>
					<?php endif ?>
					<a href="saved.php">
						...
						<span class="title">Saqlangan ishlar</span><span class="badge badge-secondary badge-roundless">
							<?php 
								$sql_saved_ready = "SELECT * FROM saved";
								$sql_saved_result = mysqli_query($connection, $sql_saved_ready);
								if (!$sql_saved_result) {
									die("Database searching error!");
								}
								else {
									$saved_works_quantity = mysqli_num_rows($sql_saved_result);
									echo $saved_works_quantity;
								}
							 ?>
						</span>
					</a>
