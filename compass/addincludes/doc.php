			...
			<div class="panel with-nav-tabs panel-success">
				<div class="panel-heading">
					<ul class="nav nav-tabs">
						...
						<? if($_GET['menu']==1){ ?>
								<li class="active"><a href="/compass/list_page.php?menu=1">Yangi shartnomalar</a></li>
						<?}else{?>
								<li><a href="/compass/list_page.php?menu=1">Yangi shartnomalar</a></li>
						<?}?>
						<?}else{?>
							<li class="active"><a href="/compass/list_page.php?menu=1">Yangi shartnomalar</a></li>
						<?}?>
						<? if($_GET['menu']==2){ ?>
							<li class="active"><a href="/compass/list_page.php?menu=2">Active</a></li>
						<?}else{?>
							<li><a href="/compass/list_page.php?menu=2">Active</a></li>
						<?}?>
						<? if($_GET['menu']==3){ ?>
							<li class="active"><a href="/compass/list_page.php?menu=3">Yopilgan</a></li>
						<?}else{?>
							<li><a href="/compass/list_page.php?menu=3">Yopilgan</a></li>
						<?}?>
						<? if($_GET['menu']==4){ ?>
							<li class="active"><a href="/compass/list_page.php?menu=4">Bekor qilingan</a></li>
						<?}else{?>
							<li><a href="/compass/list_page.php?menu=4">Bekor qilingan</a></li>
						<?}?>
					</ul>
				</div>
