		...
		<tr class="pr-row row-item">
			...
			<td>
				<div class="input-group pr-quantity">
					<input id="pr_quantity" type="number" onkeyup="items()" min="1" name="product[__i__][quantity]" class="form-control bold input-lg pr-quantity item-quantity"  value="1">
				</div>
...
<script>
	...
	<!-- /Shu yerdan asosiy conternt -->
<?php require_once('street_accept_end.php'); ?>
