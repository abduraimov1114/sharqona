...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>Price List - Sharqona (<?php echo $date->format('d.m.Y'); ?>)</title>
		...
		<div class="content-body">
			<div class="row">
				...
				<div class="col-12 mb-30">
					<div class="box">
						<div class="box-head">
							<h3 class="title">"Karmana Sharqona Invest MCHJ" xizmat ko'rsatish markazi mahsulotlar narx navosi</h3>
						</div>
						<div class="box-body">
			...
			<div class="footer-section">
				<div class="container-fluid">
					<div class="footer-copyright text-center">
						<p class="text-body-light">2019 &copy; <a style="color:red;" href="#">Sharqona<span style="font-size: 15px;font-weight: bold;color: black;">24</span></a></p>
					</div>
				</div>
			</div>
	<!-- Footer Section End -->
