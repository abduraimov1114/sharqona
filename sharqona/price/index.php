		...
		<div class="content-body">
			<div class="row">
				...
				<div class="col-12 mb-30">
					<div class="box">
						<div class="box-head">
							<h3 class="title">"Karmana Sharqona Invest" MCHJ mahsulotlar narx navosi</h3>
						</div>
						<div class="box-body">
			...
			<div class="footer-section">
				<div class="container-fluid">
					...
					<div class="footer-copyright text-center">
						<p class="text-body-light"><?php echo $year; ?> &copy; <a style="color:red;" href="#"> Karmana Sharqona<span style="font-size: 15px;font-weight: bold;color: black;">Invest</span></a></p>
					</div>
				</div>
			</div>
	<!-- Footer Section End -->
