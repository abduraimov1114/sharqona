...
<!--										<th>%</th>-->
									...
									<tr>
										...
										<td style="vertical-align: middle;display: flex;">
											...
											<a target="_blank" href="/sharqona/contract/view_info.php?url=<? echo $row['doc_url']; ?>&ID=<? echo $row['nc_id']; ?>" target="_parent" onclick="new_info(value);jQuery('#modal_view').modal('show', {backdrop: 'static'});" class="btn btn-info">
...
<!--											--><?//echo $row['pay_price']."/".$total_sum;?>
									...
									<td style="vertical-align: middle;">
										...
										<? } ?>
											...
											<a target="_blank" href="/sharqona/contract/view_info.php?url=<? echo $row['doc_url']; ?>&ID=<? echo $row['nc_id']; ?>" target="_blank" onclick="new_info(value);jQuery('#modal_view').modal('show', {backdrop: 'static'});" class="btn btn-info">
												<i class="entypo-info"></i>
											</a>
										</div>
									</td>
				...
				<div class="modal-body">
					<div class="row">
						<div class="form-group" style="display: flex; width: 65%;border:1px #ccc solid;border-radius:10px;background:rgba(0,0,0,0);margin: 0px auto;margin-bottom: 15px; align-items: center;padding: 5px 15px;justify-content: space-between;">
							...
							<div class="btn-group">
								<button type="button" id="compass" value="" onclick="korxona(id)" class="btn btn-green">Sharqoan</button>
